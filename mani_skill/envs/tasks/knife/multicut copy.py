...
class TableTopCuttingEnv(BaseEnv):
        ...
        for e in env_idx.tolist():
            ...
            if hasattr(self, "extra_objs"):
                extra_pose = Pose.create_from_pq(
                    [rand_x + 0.1, rand_y + 0.3, rand_z],  # 예: banana 옆에 고정
                    init_quat
                )
    ...
    def _after_control_step(self):
        ...
        cut_paths = [
            "./mani_skill/assets/fruits/update/cucmber/cucmber_left.obj",
            "./mani_skill/assets/fruits/update/cucmber/cucmber_right.obj",
        ]
