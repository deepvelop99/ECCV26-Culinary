...
@register_env("cucumber2cut", max_episode_steps=1000)
        ...
        for e in range(self.num_envs):
            ...
            if cut_stage == 0 and abs(tip_y - left_target_y) <= 0.03 and reached_board:
                ...
                self._replace_with_single_mesh(
                    e,
                    "/home/por1329/2025cvpr/ManiSkill/mani_skill/assets/fruits/update/cucumbertwo/cucumber_1cut_final.obj",
                    object_center_z,
                )
                self._cut_count[e] = 1
            ...
            # ===== 2차 절삭 =====
                ...
                self._replace_with_single_mesh(
                    e,
                    "/home/por1329/2025cvpr/ManiSkill/mani_skill/assets/fruits/update/cucumbertwo/cucumber_2cut_final.obj",
                    object_center_z,
                )
                self._cut_count[e] = 2
