...
@register_env("cucumbercut", max_episode_steps=1000)
class TableTopCuttingEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        for env_idx in range(self.num_envs):
            ...
            path = "./mani_skill/assets/fruits/cucumber.obj" # cucumber
    ...
    def _initialize_episode(self, env_idx: torch.Tensor, options: dict):
        ...
        for e in env_idx.tolist():
            ...
            print(f"env{rand_x,rand_y,rand_z}")
            # 초기 quat 그대로 유지
    ...
    def _after_control_step(self):
        ...
        # 잘린 mesh 경로 (cucumber 등 교체 가능)
        cut_paths = [
            "/home/por1329/2025cvpr/ManiSkill/mani_skill/assets/fruits/update/cucumber/cucumber_left.obj",
            "/home/por1329/2025cvpr/ManiSkill/mani_skill/assets/fruits/update/cucumber/cucumber_right.obj",
        ]
        ...
        for e in range(self.num_envs):
            ...
            cond_y1 = tip_p[e, 1] - 0.02 > (pose_p[1] - half[2])
            cond_y2 = tip_p[e, 1] - 0.02 < (pose_p[1] + half[2])
            cond_z2 = tip_p[e, 2] < 0.2 + (2* half[1])


            inside_tip = cond_y1 & cond_y2  & cond_z2
            print(f"  => inside_tip = {inside_tip}")
            #print(f"  Current contact[e] before: {contact[e]}, after assign: {inside_tip}\n")
