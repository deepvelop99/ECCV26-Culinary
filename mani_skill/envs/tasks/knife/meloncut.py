...
@register_env("meloncut", max_episode_steps=1000)
class TableTopCuttingEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        for env_idx in range(self.num_envs):
            ...
            path = "./mani_skill/assets/fruits/melon.obj" # melon
    ...
    def _after_control_step(self):
        ...
        # 잘린 mesh 경로 (melon 예시, apple/cucumber 등 교체 가능)
        cut_paths = [
            "./mani_skill/assets/fruits/update/melon/melon_left.obj",
            "./mani_skill/assets/fruits/update/melon/melon_right.obj",
        ]
    ...
    def _get_actor_aabb(self, actor):
        ...
        if mesh_path is None or not os.path.exists(mesh_path):
            mesh_path = "./mani_skill/assets/fruits/melon.obj"
