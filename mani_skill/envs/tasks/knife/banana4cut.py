...
@register_env("banana4cut", max_episode_steps=1000)
        ...
        for e in range(self.num_envs):
            ...
            if cut_stage == 0 and abs(tip_y - one_target_y) <= 0.1 and reached_board :
                ...
                self._replace_with_single_mesh(
                    e,
                    "./mani_skill/assets/fruits/update/banana/multicut/4cut/banana_1cut_final.obj",
                    object_center_z,
                )
                #import pdb;pdb.set_trace()
                self._cut_count[e] = 1
                ...
                self._replace_with_single_mesh(
                    e,
                    "./mani_skill/assets/fruits/update/banana/multicut/4cut/banana_2cut_final.obj",
                    object_center_z,
                )
                self._cut_count[e] = 2
                ...
                self._replace_with_single_mesh(
                    e,
                    "./mani_skill/assets/fruits/update/banana/multicut/4cut/banana_3cut_final.obj",
                    object_center_z,
                )
                self._cut_count[e] = 3
                ...
                self._replace_with_single_mesh(
                    e,
                    "./mani_skill/assets/fruits/update/banana/multicut/4cut/banana_4cut_final.obj",
                    object_center_z,
                )
                self._cut_count[e] = 4
