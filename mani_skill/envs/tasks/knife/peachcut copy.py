...
@register_env("peachcut", max_episode_steps=1000)
class TableTopCuttingEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        for env_idx in range(self.num_envs):
            ...
            path = "./mani_skill/assets/fruits/peach.obj" # peach
    ...
    def _after_control_step(self):
        ...
        # 잘린 mesh 경로 (peach 예시, apple/cucumber 등 교체 가능)
        cut_paths = [
            "./mani_skill/assets/fruits/update/peach/peach_left.obj",
            "./mani_skill/assets/fruits/update/peach/peach_right.obj",
        ]
        ...
        for e in range(self.num_envs):
            ...
            reached_board = tip_z <= board_z + 1e-1   # 작은 margin 허용
            ...
            if reached_board and (not self._already_cut[e]):
                ...
                for cut_path in cut_paths:
                    ...
                    builder.add_convex_collision_from_file(str(p), scale=[1, 1, 1])
                    ...
                    dy = random.uniform(0.005, 0.01)   # y축 이동량 (좌우)
    ...
    def _get_actor_aabb(self, actor):
        ...
        if mesh_path is None or not os.path.exists(mesh_path):
            mesh_path = "./mani_skill/assets/fruits/peach.obj"
