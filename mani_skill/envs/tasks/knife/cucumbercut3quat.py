...
@register_env("cucumbercut3quat", max_episode_steps=1000)
class TableTopCuttingEnv(BaseEnv):
    ...
    def _after_control_step(self):
        ...
        # 잘린 mesh 경로 (cucumber 예시, apple/cucumber 등 교체 가능)
        cut_paths = [
            '/home/por1329/2025cvpr/ManiSkill/cutted3/cut_joined0.75.obj'
        ]
