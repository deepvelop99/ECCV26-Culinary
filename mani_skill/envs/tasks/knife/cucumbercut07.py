...
@register_env("cucumbercut0.7", max_episode_steps=1000)
class TableTopCuttingEnv(BaseEnv):
    ...
    def _after_control_step(self):
        ...
        cut_paths = [
            '/home/por1329/2025cvpr/ManiSkill/cutted3/cut_joined0.7.obj'
        ]
        ...
        for e in range(self.num_envs):
            ...
            one_target_y  = object_center_y +2/10 * object_width
