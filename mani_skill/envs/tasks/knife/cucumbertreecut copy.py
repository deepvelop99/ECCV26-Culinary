...
class TableTopCuttingEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        for env_idx in range(self.num_envs):
            path = "/home/por1329/2025cvpr/fruits/cucumber.obj"
    ...
    def _get_actor_aabb(self, actor):
        ...
        if mesh_path is None or not os.path.exists(mesh_path):
            mesh_path = "/home/por1329/2025cvpr/fruits/cucumber.obj"
        ...
        for e in range(self.num_envs):
            ...
            if cut_stage == 0 and abs(tip_y - left_target_y) <= 0.03 and reached_board:
                ...
                self._replace_with_single_mesh(
                    e,
                    "/home/por1329/2025cvpr/fruits/update/cucumber/multicut/3cut/cucumber_1cut_final.obj",
                    object_center_z,
                )
                self._cut_count[e] = 1
            ...
            # ===== 2차 절삭 =====
                ...
                self._replace_with_single_mesh(
                    e,
                    "/home/por1329/2025cvpr/fruits/update/cucumber/multicut/3cut/cucumber_2cut_final.obj",
                    object_center_z,
                )
                self._cut_count[e] = 2
            ...
            # ===== 3차 절삭 =====
                ...
                self._replace_with_single_mesh(
                    e,
                    "/home/por1329/2025cvpr/fruits/update/cucumber/multicut/3cut/cucumber_3cut_final.obj",
                    object_center_z,
                )
                self._cut_count[e] = 3
