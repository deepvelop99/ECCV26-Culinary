...
def main(args: Args):
    ...
    y_offsets = [-dy + 0.01, 0.0, dy + 0.01]  # 상대 오프셋들
    ...
    for i, y_off in enumerate(y_offsets):
        ...
        move_to_pose(env, init_pose_world, approach_pose, steps=100, kp=10.0, clip=0.03, gripper_delta=0.0)
        move_to_pose(env, approach_pose,    cut_pose,    steps=randomspeed, kp=20.0, clip=0.1, gripper_delta=0.0)
        move_to_pose(env, cut_pose,         retreat_pose,steps=100, kp=10.0, clip=0.03, gripper_delta=0.0)
